...
const Navbar = (props) => <React.Fragment>
  ...
  <Link to={props.user && `/ledger/${props.user.id}`} className="navbar4 d-flex flex-column justify-content-center align-items-center nav-item"><i className="fas fa-cash-register"></i><p>Ledger</p></Link>
  </React.Fragment>;
